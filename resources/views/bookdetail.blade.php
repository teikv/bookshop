...
<div class="container">
  <div class="row">
    ...
    <div class="col-lg-7 col-md-6">
      ...
      <div class="price-group d-flex align-items-center mb-3">
        <label for="quantity" class="price-number mr-3">Số lượng:</label>
        <div class="input-group" style="width: 150px;">
          <button class="btn btn-outline-secondary" type="button">-</button>
          <input type="text" id="quantity" class="form-control form-price text-center" value="3">
          <button class="btn btn-outline-secondary" type="button">+</button>
        </div>
      </div>
