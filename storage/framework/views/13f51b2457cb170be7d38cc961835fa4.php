    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <b><?php echo e(auth()->user()->name); ?>, <?php echo e(__("You're logged in!")); ?>
                ...
                <form action="<?php echo e(route('logout')); ?>" method="POST">
                        ...
                        <form action="<?php echo e(route('logout')); ?>" method="POST">
                            ...
                            <button type="submit"
                                ...
                                <span class="ml-4"><?php echo e(__('Logout')); ?></span>
                            </button>
                        </form>
                    </form>
            </div>
...
<?php endif; ?>
<?php /**PATH D:\xampp\htdocs\bookshop\resources\views/dashboard.blade.php ENDPATH**/ ?>