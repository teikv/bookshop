    ...
    <div class="container my-3">
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?php echo e(url('/booklist')); ?>">Book</a></li>
                    ...
                    <div class="bg-light d-flex align-items-center justify-content-center product-image">
                        ...
                        <div class="col-lg-7 col-md-6">
                            ...
                            <div class="d-flex">
                                ...
                                <button class="btn btn-primary" onclick="window.location.href='<?php echo e(url('/payment')); ?>'">Mua
                                    ngay</button>
                                >>>>>>> origin/payment
                            </div>
                        </div>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\bookshop\resources\views/bookdetail.blade.php ENDPATH**/ ?>