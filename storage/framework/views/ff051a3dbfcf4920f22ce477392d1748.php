    ...
    <div class="col-md-9">
        ...
        <div class="row">
            ...
            <div class="col-md-3 mb-4">
                <div class="card book-card" onclick="window.location.href='<?php echo e(url('/bookdetail')); ?>'">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\bookshop\resources\views/booklist.blade.php ENDPATH**/ ?>